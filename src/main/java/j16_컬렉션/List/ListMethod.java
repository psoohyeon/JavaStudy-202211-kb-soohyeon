...
public class ListMethod {
	...
	public static void main(String[] args) {
		...
		System.out.println("해당 리스트가 비어 있는가? " + isEmpty);
		...
		while (ir.hasNext()) { // isnext 이다, 아니다  hasnext 있다 없다 
